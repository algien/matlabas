...
n=2;
k1=50;%dvimatis (Tasku (vektoriu) skaicius)
...
b3=xMin1(2)+1;
n=2;
k2=50;%dvimatis (Tasku (vektoriu) skaicius)
x2(:,1)=a2 + (b2-a2).* rand(50,1); %padaryti, kad generuotu dvimacius vektorius
x2(:,2)=a3 + (b3-a3).* rand(50,1);
f2=[];
 for i=1:50
 f2(i)=sincos2(x2(i,:));
 end
